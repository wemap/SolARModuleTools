...
int main(int argc,char** argv)
{
    ...
    if (xpcfComponentManager->load("SolARTest_ModuleTools_3DTransformEstimationSACFrom3D3D_conf.xml") != org::bcom::xpcf::_SUCCESS)
	{
        LOG_ERROR("Failed to load the configuration file SolARTest_ModuleTools_3DTransformEstimationSACFrom3D3D_conf.xml")
			return -1;
	}
