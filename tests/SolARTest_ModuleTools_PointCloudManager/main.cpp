...
int main(int argc, char* argv[])
{
    ...
    if (xpcfComponentManager->load("SolARTest_ModuleTools_PointCloudManager_conf.xml") != org::bcom::xpcf::_SUCCESS)
	{
        std::cerr << "Failed to load the configuration file SolARTest_ModuleTools_PointCloudManager_conf.xml" << std::endl;
		return -1;
	}
