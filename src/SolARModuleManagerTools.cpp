...
SolARModuleManagerTools::SolARModuleManagerTools()
{
...
SolARModuleManagerTools::SolARModuleManagerTools(const char *iniFile)
{
    ...
    #else
    xpcf_xmlPath=pt.get<std::string>("Tools.xmlReleasePath");
    xpcf_libPath=pt.get<std::string>("Tools.libReleasePath");
    #endif
